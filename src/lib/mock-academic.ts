...
export const WRITING_SUGGESTIONS = [
  ...
  },
  {
    ...
    explanation: "学术��作倾向于描述过程的‘效率’而非单纯的‘速度’。"
  }
];
export const ACHIEVEMENT_LIST = [
  { id: 'a1', name: '学术晨星', description: '连�� 7 天在 8:00 前开始修行', icon: Flame, requirement: '7日早起' },
  { id: 'a2', name: '藏经阁阁长', description: '累计研读论文超过 50 篇', icon: Book, requirement: '50篇论文' },
  { id: 'a3', name: '神识通达', description: '���力对战相似度达到 95% 以上', icon: Brain, requirement: '听力 95%+' },
  { id: 'a4', name: '妙笔生花', description: '单次写作字数突破 5000 字', icon: PenTool, requirement: '5000字创作' },
  { id: 'a5', name: '番茄大师', description: '单日完成 12 个番茄钟专注', icon: Zap, requirement: '12番茄/日' },
  { id: 'a6', name: '境界稳固', description: '总修行天数达到 100 天', icon: Trophy, requirement: '100日达成' },
  { id: 'a7', name: '社交达人', description: '在论道���获得 50 个点赞', icon: Sparkles, requirement: '50个赞' },
...
export const VOCAB_DATA = [
  {
    ...
    mnemonic: "记忆术：Prag (Play/Practice) + matic (Auto). 经���实践的人很务实。",
  ...
  },
  {
    ...
    phonetic: "/ˈpærədaɪm/",
    definition: "范式，典范",
    mnemonic: "记忆术：Para (Side) + digm (Example). 摆在旁边的标准例���。",
  ...
  },
  {
    ...
    phonetic: "/ˈmɪtɪɡeɪt/",
    definition: "减��，缓和",
    mnemonic: "记忆术：Mit (Mild) + gate. 把��门关小一点，减轻伤害。",
...
export const LISTENING_DATA = [
  ...
  {
    id: "l2",
    text: "Researchers must carefully consider the ethical implications of their findings.",
    startTime: 4.5,
    endTime: 9.0,
    amplitude: [30, 60, 40, 85, 95, 20, 55, 75, 50, 30]
  },
  {
    id: "l3",
    text: "Statistical significance is not always indicative of real-world impact.",
    startTime: 9.0,
    endTime: 13.5,
    amplitude: [15, 35, 70, 40, 60, 80, 90, 45, 30, 10]
  }
];
