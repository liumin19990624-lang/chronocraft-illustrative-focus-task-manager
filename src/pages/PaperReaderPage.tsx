...
import { FileText, Brain, Sparkles, Languages, Bookmark, Share2, Network, ChevronDown, ListTree } from 'lucide-react';
    ...
    <AppLayout container>
      <header className="mb-10 flex flex-col md:flex-row md:items-start justify-between gap-6">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-medium text-lg italic">{PAPER_DATA.authors}</p>
        </div>
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <div className="mt-12 p-6 rounded-3xl bg-primary/5 border border-primary/10 flex items-center justify-between group cursor-help">
                  <span className="text-sm font-bold text-muted-foreground flex items-center gap-2">
                    <Sparkles className="h-4 w-4 text-purple-500" /> ��击段落触发 AI 句法拆解
                  </span>
        ...
        <aside className="lg:col-span-4 space-y-8 sticky top-8">
          <div className="flex items-center justify-between px-4">
            <h2 className="text-2xl font-display font-bold flex items-center gap-3">
              <Brain className="h-6 w-6 text-purple-500" /> 神识分��
            </h2>
            ...
            {showAnalysis && (
              ...
              >
                ...
                <div className="bg-slate-900 p-8 rounded-[2.5rem] text-center space-y-4">
                  <p className="text-xs italic text-slate-400 font-medium">“读万卷���，不如 AI 导读。”</p>
